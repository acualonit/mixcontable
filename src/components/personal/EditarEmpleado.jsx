...
function EditarEmpleado({ empleado, onClose, onSave }) {
  const [formData, setFormData] = useState({
    // Datos Personales
    nombreCompleto: empleado.nombreCompleto || '',
    tipoDocumento: empleado.tipoDocumento || 'rut',
    ...
    fechaIngresoLaboral: empleado.fechaIngresoLaboral || '',
    sucursal: empleado.sucursal || '',

    // Datos Laborales
    cargo: empleado.cargo || '',
    salarioLiquidoReal: empleado.salarioLiquidoReal?.toString() || '',
    ...
    fechaVencimientoContrato: empleado.fechaVencimientoContrato || '',
    salarioBruto: empleado.salarioBruto?.toString() || '',
    gratificacion: empleado.gratificacion?.toString() || '',
    entidadSalud: empleado.entidadSalud || 'Fonasa',
    nombreIsapre: empleado.nombreIsapre || '',
    tipoCotizacion: empleado.tipoCotizacion || 'Pesos',
    valorCotizacion: empleado.valorCotizacion?.toString() || '',

    // Estado
    estado: empleado.estado || 'Activo-Laborando'
  });
  ...
  const handleSubmit = (e) => {
    ...
    onSave({
      ...formData,
      salarioLiquidoReal: parseFloat(formData.salarioLiquidoReal),
      salarioBruto: parseFloat(formData.salarioBruto),
      gratificacion: parseFloat(formData.gratificacion),
      valorCotizacion: parseFloat(formData.valorCotizacion)
    });
  };
