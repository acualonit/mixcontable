...
function EditarOtroEgreso({ egreso, onClose, onSave }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.incluirFlujoCaja && formData.metodoPago === 'efectivo' && egreso.metodoPago !== 'efectivo') {
      try {
        await registrarMovimientoEfectivo({
          fecha: formData.fecha,
          valor: parseFloat(formData.monto),
          detalle: `Otro egreso (Editado) - ${formData.categoria}: ${formData.descripcion}`,
          tipo: 'egreso',
    ...
    onSave({
      ...
      historial: [
        ...egreso.historial,
        {
          ...
          accion: 'Edición',
          detalles: 'Modificación de datos del egreso'
        }
      ]
    });
  };
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header bg-warning">
            <h5 className="modal-title">Editar Egreso</h5>
...
export default EditarOtroEgreso;