...
function NuevoOtroIngreso({ onClose, onSave }) {
    ...
    if (formData.incluirFlujoCaja && formData.metodoPago === 'efectivo') {
      try {
        await registrarMovimientoEfectivo({
          ...
          detalle: `Otro ingreso - ${formData.categoria}: ${formData.descripcion}`,
          tipo: 'ingreso',
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header bg-success text-white">
            <h5 className="modal-title">Nuevo Ingreso</h5>
...
export default NuevoOtroIngreso;