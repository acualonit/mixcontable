...
function MainContent({ currentDateTime, sidebarCollapsed }) {
  return (
    <div className={`main-content content-wrapper ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
                ...
                <div className="table-responsive">
                  <table className="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Cheque</td>
                        <td>Pago mantención</td>
                        <td>18/12/2023</td>
                        <td className="text-danger">$450,000</td>
                        <td>
                          <button className="btn btn-sm btn-outline-primary">
                            <i className="bi bi-eye"></i>
                          </button>
                  ...
                  <table className="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>22/12/2023</td>
                        <td className="text-success">$1,500,000</td>
                        <td>
                          <button className="btn btn-sm btn-outline-primary">
                            <i className="bi bi-eye"></i>
                          </button>
                      ...
                      <tr>
                        <td>Cuentas Por Cobrar</td>
                        <td>Factura cliente DEF</td>
                        <td>28/12/2023</td>
                        <td className="text-success">$950,000</td>
                        <td>
                          <button className="btn btn-sm btn-outline-primary">
                            <i className="bi bi-eye"></i>
                          </button>
